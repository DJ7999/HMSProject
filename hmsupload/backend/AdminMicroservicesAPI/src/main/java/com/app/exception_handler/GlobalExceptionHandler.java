...
import com.app.custom_exception.ResourceAlreadyPresentException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException e) {
		...
		return ResponseEntity.status(HttpStatus.NOT_FOUND)
				.body(new ErrorResponse("Invalid", e.getMessage()));
	}
	
//	
//	@ExceptionHandler(ResourceAlreadyPresentException.class)
//	public ResponseEntity<?> handleResourceAlreadyPresentException(ResourceAlreadyPresentException e){
